...
|---|----------|---------------|
| 1 | Страница в сайдбаре | Admin → в разделе «Администрирование» пункт «Незаполнившие дни» |
| 2 | Таблица загружается | Сотрудники без логов за месяц отображаются |
| 3 | Счётчик дней | `unlogged_count` оранжевым цветом |
| 4 | Раскрытие строки | Клик по стрелке → список дат в оранжевом блоке |
| 5 | Пустой список → успех | Все заполнили → зелёное сообщение с иконкой ✓ |
| 6 | Навигация по месяцам | ← → перегружает данные |
| 7 | Экспорт Excel | Скачивается файл |
