...
| 2 | Карточки загружаются | Три Card с цифрами из API | ✅ выполнено |
| 3 | Диаграмма часов по проектам | Круговая диаграмма с легендой справа | ✅ выполнено |
| 4 | Диаграмма сотрудников | Вторая диаграмма с количеством сотрудников | ✅ выполнено |
| 5 | Клик по карточке «Недоработка» | Dialog открывается с таблицей сотрудников, `deviation < 0` | ✅ выполнено |
| 6 | Клик по карточке «Переработка» | Dialog с `deviation > 0` | ✅ выполнено |
| 7 | Клик по карточке «Незаполненные» | Dialog с `unlogged_count > 0` | ✅ выполнено |
| 8 | TOP-2 проектов в таблице | Колонка содержит до 2 проектов с часами | ✅ выполнено |
| 9 | Переход в Отчёт по пользователю | Кнопка-иконка → роут `/user?user_id=...` | ✅ выполнено |
| 10 | Навигация по месяцам | ← → меняет месяц, данные обновляются | ✅ выполнено |
